...
class paxSlider {
  constructor(t, e = {}) {
    if ((this.bindAll(), this.isElement(t)))
      (this.el = t), (this.el.pax_slider = this);
    else {
      const i = document.querySelectorAll(t);
      for (let t = 0; t < i.length; t++) {
        let s = i[t];
        if (0 == t) (this.el = s), (this.el.pax_slider = this);
        else {
          new paxSlider(s, e);
        }
      }
    ...
    (this.opts = Object.assign(
      {
        ...
        eventTarget: ".pax-slider",
        inner: ".pax-slider-viewport",
        slides: ".pax-slide",
        clones: "pax-slide-clone",
        snap: !1,
      ...
      this.isObject(this.opts.navigation) ||
        (1 == this.opts.navigation &&
          ((this.btnNext = this.el.querySelector(".pax-button-next")),
          (this.btnPrev = this.el.querySelector(".pax-button-prev")))),
      this.isObject(this.opts.navigation) &&
      ...
      this.isObject(this.opts.pagination) ||
        (1 == this.opts.pagination &&
          (this.elPagination = this.el.querySelector(".pax-pagination"))),
      this.isObject(this.opts.pagination) &&
  ...
  setup() {
    ...
    if (null != this.elPagination)
      for (let e = 0; e < t.length; e++) {
        ...
        i.classList.add("pax-pagination-bullet"),
  ...
  updateUI() {
    ...
    for (let a = 0; a < this.items.length; a++) {
      ...
      if (
        (Math.abs(o) < h.length / 2
          ? (h.el.classList.add("pax-slide-active"),
            h.nextElement.el.classList.add("pax-slide-next"),
            h.nextElement.nextElement.el.classList.add("pax-slide-next-two"),
            h.nextElement.nextElement.nextElement.el.classList.add(
              "pax-slide-next-three"
            ),
            h.prevElement.el.classList.add("pax-slide-prev"),
            h.prevElement.prevElement.el.classList.add("pax-slide-prev-two"),
            h.prevElement.prevElement.prevElement.el.classList.add(
              "pax-slide-prev-three"
            ),
          ...
          : (h.el.classList.remove("pax-slide-active"),
            h.nextElement.el.classList.remove("pax-slide-next"),
            ...
            h.prevElement.el.classList.remove("pax-slide-prev"),
        ...
        h.end + r > e && h.start + r < t + e
          ? h.el.classList.add("pax-slide-visible")
          : h.el.classList.remove("pax-slide-visible"),
        h.translate != r)
      ) {
    ...
    this.state.flags.dragging
      ? this.el.classList.add("pax-state-dragging")
      : this.el.classList.remove("pax-state-dragging"),
  ...
  updatePaginationUI() {
    if (
      ...
      null != i && i.el.classList.add("pax-pagination-bullet-active");
      let s = e - 1;
      s < 0 && (s = this.itemsPagination.length - 1);
      let n = this.itemsPagination[s];
      null != n && n.el.classList.add("pax-pagination-bullet-prev");
      let l = e + 1;
      l >= this.itemsPagination.length && (l = 0);
      let a = this.itemsPagination[l];
      null != a && a.el.classList.add("pax-pagination-bullet-next");
      for (let t = 0; t < this.itemsPagination.length; t++) {
        let i = this.itemsPagination[t];
        t != e && i.el.classList.remove("pax-pagination-bullet-active"),
          t != l && i.el.classList.remove("pax-pagination-bullet-next"),
          t != s && i.el.classList.remove("pax-pagination-bullet-prev");
      }
    }
  }
  parallax() {

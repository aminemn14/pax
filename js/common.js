...
---------------------------------------------------*/
  ...
  window.ScrollEffects = function () {
    ...
    if (!$("body").hasClass("stories-nav-text")) {
      if ($("#stories-nav").length > 0) {
        $("#main-content").addClass("solid-color");
        $("#main-page-content").addClass("stories-page");
      }
    }

    if ($(".liste").length > 0) {
      $("#main-content").addClass("liste-page");
    }
    ...
    if (isMobile()) {
      ...
      $(
        ".smooth-scroll main, .has-parallax, nav, .pax-slider-wrapper:not(.content-slider), .showcase-lists .pax-sync-slider, .next-stories-image-wrapper, .slider-fixed-content"
      ).css({ height: winHeight });
      $("#main-page-content.stories-page").css({
    ...
    if (
      $("body").hasClass("load-stories-thumb") ||
      $("body").hasClass("load-stories-thumb-with-title")
    ) {
      const delayTime = $("body").hasClass("load-stories-thumb-with-title")
        ? 0.6
        : 1.2;
      ...
      if ($(".move-thumbs-wrapper").length > 0) {
        if (!isMobile()) {
          ...
          const moveThumbsParent = document.querySelectorAll(
            ".start-thumbs-wrapper .start-move-thumb"
          );
          const moveThumbs = document.querySelectorAll(
            ".start-thumbs-wrapper .move-thumb-inner"
          );
          const endThumbsWrapper = document.querySelector(
            ".end-thumbs-wrapper"
          );
          const overlappingThumbs = document.querySelectorAll(
            ".end-thumbs-wrapper .end-move-thumb"
          );
    ...
    var NextheroPin = gsap.to(".next-stories-wrap", {
      duration: 1,
      ease: Linear.easeNone,
      scrollTrigger: {
        trigger: ".next-stories-wrap",
        start: "top top",
        end: "+=100%",
        pin: true,
        scrub: true,
    ...
    var nextStoriesImageParallax = gsap.to(".next-stories-image", {
      duration: 1,
    ...
    var nextStoriesProgress = gsap.to(".next-hero-progress span", {
      duration: 1,
      width: "100%",
      ease: Linear.easeNone,
      scrollTrigger: {
    ...
    if ($("#pax-page-content").hasClass("light-content")) {
      if ($("#stories-nav").hasClass("change-header")) {
        imagesLoaded("body", function () {
          setTimeout(function () {
            var pageNav = document.querySelector("#stories-nav.change-header");
            if (pageNav) {
              var pageContent = document.querySelector("#pax-page-content");
              var nextPageCaptionParallax = gsap.to(".page-nav-caption", {
                scrollTrigger: {
                  trigger: pageNav,
                  start: "top 8%",
    ...
    if ($("#pax-page-content").hasClass("dark-content")) {
      if ($("#stories-nav").hasClass("change-header")) {
        imagesLoaded("body", function () {
          setTimeout(function () {
            var pageNav = document.querySelector("#stories-nav");
            if (pageNav) {
              var pageContent = document.querySelector("#pax-page-content");
              var nextPageCaptionParallax = gsap.to(".page-nav-caption", {
                scrollTrigger: {
...
---------------------------------------------------*/
  ...
  window.FirstLoad = function () {
    ...
    if ($("#pax-page-content").hasClass("light-content")) {
      ...
      gsap.to("main", {
        ...
        backgroundColor: document
          .querySelector("#pax-page-content")
          .getAttribute("data-bgcolor"),
        ease: Power2.easeInOut,
      });
    ...
    $("a.ajax-link").on("click", function () {
      ...
      gsap.to(
        $(
          "#main, #hero-image-wrapper, #stories-nav, .next-stories-image, #app, #canvas-slider, #showcase-slider-webgl-holder, .showcase-pagination-wrap, #quickmenu-scroll, #blog, .next-stories-image-wrapper"
        ),
          ...
          $body.on("mouseup mousemove", function handler(evt) {
            if (evt.type === "mouseup") {
              $(
                ...
                if (!$("#pax-page-content").hasClass("light-content")) {
                  if (!$(".liste").hasClass("liste-shortcode")) {
                ...
                $(".pax-slider .trigger-item").each(function () {
                ...
                gsap.to(
                  "#hero, #show-filters, .item-caption-wrapper, .showcase-liste .slide-caption, #page-nav, footer, .fadeout-element",
      ...
      if ($("#itemsWrapper").hasClass("no-fitthumbs")) {
        $("#itemsWrapperLinks .trigger-item-link").on("click", function () {
          ...
          const fadeOutTargets = $(
            "#hero, #show-filters, .pax-slider, .item, .item-caption-wrapper, #page-nav, footer, .fadeout-element"
          );
          const ball = $("#ball");
...
---------------------------------------------------*/
  ...
  window.Sliders = function () {
    if ($(".content-slider").length > 0) {
      slider = new paxSlider(".content-slider", {
      ...
      $(".slider-button-prev")
        .mouseenter(function (e) {
          if ($(this).parents(".pax-slider-wrapper").hasClass("light-cursor")) {
            ...
            $(this).parents(".pax-slider-wrapper").hasClass("dark-cursor")
          ) {
      ...
      $(
        ".content-slider.looped-carousel .pax-slider, .content-slider.small-looped-carousel .pax-slider"
      )
...
---------------------------------------------------*/
  ...
  window.Lightbox = function () {
    ...
    function showDetails(item) {
      ...
      $("body").prepend(`<div class="pax-img-popup">
				<div class="pax-img-popup-bg-close"></div>				
				<div class="pax-img-popup-viewport">
					<div class="pax-img-popup-preloader"><div></div><div></div><div></div><div></div></div>					
					<img />
					<div class="pax-img-popup-close link"></div>						
				</div>				
				<div class="pax-img-popup-prev link"></div>
				<div class="pax-img-popup-next link"></div></div>`);

      const details = document.querySelector(".pax-img-popup");
      const detailsBgClose = document.querySelector(".pax-img-popup-bg-close");
      const detailsClose = document.querySelector(".pax-img-popup-close");
      const detailsPreloader = document.querySelector(
        ".pax-img-popup-preloader"
      );
      const detailImage = document.querySelector(".pax-img-popup img");
      const detailPrev = document.querySelector(".pax-img-popup-prev");
      const detailNext = document.querySelector(".pax-img-popup-next");
    ...
    function showVideoDetails(event, item) {
      ...
      $("body").prepend(`<div class="pax-video-popup">
				<div class="pax-video-popup-bg-close"></div>				
				<div class="pax-video-popup-viewport">
					<div class="pax-video-popup-preloader"><div></div><div></div><div></div><div></div></div>					
					<iframe class="pax-video-popup-iframe" frameborder="0" allow="autoplay"></iframe>
					<div class="pax-video-popup-close link"></div>						
				</div>				
				<div class="pax-img-video-prev link"></div>
				<div class="pax-img-video-next link"></div></div>`);

      const details = document.querySelector(".pax-video-popup");
      const detailsBgClose = document.querySelector(
        ".pax-video-popup-bg-close"
      );
      const detailsClose = document.querySelector(".pax-video-popup-close");
      const detailsPreloader = document.querySelector(
        ".pax-video-popup-preloader"
      );
      const detailIframe = document.querySelector(".pax-video-popup iframe");
...
---------------------------------------------------*/
  ...
  window.Core = function () {
    if (!isMobile() && !$("body").hasClass("disable-cursor")) {
      ...
      $(".pax-button .sticky.left").mouseenter(function (e) {
        var rcBounds = $(this)[0].getBoundingClientRect();
      ...
      $(".pax-button .sticky.right").mouseenter(function (e) {
        var rcBounds = $(this)[0].getBoundingClientRect();
      ...
      $(".pax-button .parallax-wrap.icon-wrap").mouseenter(function (e) {
        gsap.to(ball, {
          duration: 0.05,
          scale: 0.4,
          borderWidth: "0px",
      ...
      $(".pax-button .sticky").mouseenter(function (e) {
        if ($("#pax-page-content").hasClass("light-content")) {
      ...
      $(".pax-button .parallax-wrap").mouseenter(function (e) {
        if ($("#pax-page-content").hasClass("light-content")) {
      ...
      //Blog Hover Effects
      $(
        "#blog-page-nav .page-numbers li a, .post-page-numbers, #post-content a, #post-form a, #post-comments a, .wp-block-search__button, .pax-sidebar-widget a"
      ).mouseenter(function (e) {
        gsap.to("#ball", {
          duration: 0.2,
          borderWidth: "1px",
    ...
    jQuery(document).ready(function () {
      ...
      function loadNewContent(url, bool) {
        ...
        section.load(url + " .cd-main-content > *", function (event) {
          ...
          var pax_title = event.match(/<title[^>]*>([^<]+)<\/title>/)[1];
          $("head title").html(pax_title);
          ...
          setTimeout(function () {
            ...
            if (!isMobile() && !$("body").hasClass("disable-cursor")) {
              ...
              $(".pax-button .parallax-wrap.icon-wrap").mouseenter(function (
                e
              ) {
                gsap.to(ball, {
                  duration: 0.05,
